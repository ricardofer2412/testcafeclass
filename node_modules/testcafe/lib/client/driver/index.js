...
(function () {
    function initTestCafeClientDrivers(window, isIFrameWithoutSrc) {
        ...
        (function (hammerhead, Promise$2, testcafeCore, testcafeAutomation, testcafeUi) {
    ...
    ***************************************************************************** */
    ...
    var EventEmitter = /** @class */ (function () {
        ...
        EventEmitter.prototype.off = function (evt, listener) {
            ...
            if (listeners)
                this._eventsListeners[evt] = adapter$1.nativeMethods.arrayFilter.call(listeners, function (item) { return item !== listener; });
        };
    ...
    function delay(ms) {
        var setTimeout = adapter$1.nativeMethods.setTimeout;
        return new adapter$1.PromiseCtor(function (resolve) { return setTimeout(resolve, ms); });
    }
    ...
    var ElementsRetriever = /** @class */ (function () {
        function ElementsRetriever(globalSelectorTimeout, executeSelectorFn) {
            ...
            this._ensureElementsStartTime = adapter$1.nativeMethods.dateNow();
            this._ensureElementsPromise = adapter$1.PromiseCtor.resolve();
    ...
    var ActionExecutor = /** @class */ (function (_super) {
        ...
        ActionExecutor.prototype._isExecutionTimeoutExpired = function () {
            return adapter$1.nativeMethods.dateNow() - this._executionStartTime >= this._commandSelectorTimeout;
        };
        ...
        ActionExecutor.prototype._ensureCommandOptions = function () {
            ...
            if (this._elements.length && opts && 'offsetX' in opts && 'offsetY' in opts) { // @ts-ignore
                var _a = adapter$1.getOffsetOptions(this._elements[0], opts.offsetX, opts.offsetY), offsetX = _a.offsetX, offsetY = _a.offsetY;
                // @ts-ignore TODO
        ...
        ActionExecutor.prototype.execute = function (barriers) {
            var _this = this;
            this._executionStartTime = adapter$1.nativeMethods.dateNow();
            try {
                ...
                return adapter$1.PromiseCtor.reject(err);
            }
    ...
    var RequestBarrier = /** @class */ (function () {
        ...
        RequestBarrier.prototype._finishWaiting = function () {
            if (this._watchdog) {
                var clearTimeout_1 = adapter$1.nativeMethods.clearTimeout;
        ...
        RequestBarrier.prototype.wait = function (isPageLoad) {
            ...
            return delay$1(isPageLoad ? this._delays.pageInitialRequestsCollection : this._delays.requestsCollection)
                .then(function () { return new adapter$1.PromiseCtor(function (resolve) {
    ...
    var ScriptExecutionBarrier = /** @class */ (function () {
        ...
        ScriptExecutionBarrier.prototype._finishWaiting = function () {
            if (this._watchdog) {
                var clearTimeout_2 = adapter$1.nativeMethods.clearTimeout;
        ...
        ScriptExecutionBarrier.prototype.wait = function () {
            var _this = this;
            return new adapter$1.PromiseCtor(function (resolve) {
                _this._waitResolve = resolve;
    ...
    var BarriersComplex = /** @class */ (function () {
        ...
        BarriersComplex.prototype.wait = function () {
            var _this = this;
            return adapter$1.PromiseCtor.all([
                // NOTE: script can be added by xhr-request, so we should run
                // script execution barrier waiting after request barrier resolved
